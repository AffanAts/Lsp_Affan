...
if (isset($_GET['id_artikel'])) {
    ...
    $query = "SELECT artikel.*, komentar.nama, komentar.komentar, komentar.email, komentar.tanggal_komentar 
        FROM artikel
            ...
            <div class="col-lg-8">
                ...
                <article>
                    ...
                    <header class="mb-4">
                        ...
                        <!-- Post meta content-->
                        <div class="text-muted fst-italic mb-2">Posted on <?php echo date('F j, Y h:i A', strtotime($data['tanggal_komentar'])); ?> by Affan Haidar</div>
                        <!-- Post categories-->
                    ...
                    <figure class="mb-4">
                        <img class="rounded mx-auto d-block img-fluid" style="width: 600px; height:300px" src="../admin/Artikel/gambar/<?php echo $data['gambar_artikel']; ?>">
                    </figure>
                    <!-- Post content-->
                    <section class="mb-5">
                        <p class="fs-5 mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form class="mx-1 mx-md-4" method="POST" action="proses_tambahK.php" enctype="multipart/form-data">
                                ...
                                <div class="d-flex flex-row align-items-center mb-4">
                                    ...
                                    <div class="form-outline flex-fill mb-0">
                                        <textarea type="text" name="komentar" id="textAreaExample" rows="4" class=" form-control"></textarea>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    <div class="d-flex flex-row align-items-center">
                                                        <img class="rounded-circle" src="https://loremflickr.com/320/240?random=<?php echo rand(); ?>" alt="..." style="width:50px;height:50px" />
                                                        <p class="small mb-0 ms-2">
                                                            <?php echo $comment['nama']; ?>
                                                        </p>
                                                    </div>
                                                    <div class="d-flex flex-row align-items-center">
                                                        <p class="small text-muted mb-0">Posted on <?php echo date('F j, Y h:i A', strtotime($comment['tanggal_komentar'])); ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
