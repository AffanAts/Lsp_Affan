...
if (isset($_GET['id_artikel'])) {
  ...
  $query = "SELECT artikel.*, komentar.nama, komentar.komentar, komentar.email 
    FROM artikel
      ...
      <div class="col-lg-8">
        ...
        <article>
          ...
          <header class="mb-4">
            ...
            <!-- Post meta content-->
            <div class="text-muted fst-italic mb-2">Posted on January 1, 2023 by Affan Haidar</div>
            <!-- Post categories-->
            <a class="badge bg-secondary text-decoration-none link-light" href="#!">Web Design</a>
            <a class="badge bg-secondary text-decoration-none link-light" href="#!">Freebies</a>
          </header>
          <!-- Preview image figure-->
          <figure class="mb-4"> <img class="rounded mx-auto d-block img-fluid" style="width: 600px; height:300px"
              src="../admin/Artikel/gambar/<?php echo $data['gambar_artikel']; ?>"></figure>
          <!-- Post content-->
          <section class="mb-5">
            <p class="fs-5 mb-4">
                      ...
                      <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                          <div class="d-flex flex-row align-items-center">
                            <img class="rounded-circle" src="https://loremflickr.com/320/240?random=<?php echo rand(); ?>"
